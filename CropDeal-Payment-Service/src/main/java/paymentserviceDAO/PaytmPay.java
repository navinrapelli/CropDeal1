...
public class PaytmPay {
	...
	public PaytmPay(String merchantId, String merchantKey, String channelId, String website, String industryTypeId,
	...
	public String toString() {
		return "PaytmPay [merchantId=" + merchantId + ", merchantKey=" + merchantKey + ", channelId=" + channelId
